...
public class Condicionais {
    ...
    public static void main(String[] args) {
        ...
        //chamar os métodos exemploIfElse com o valor1
        System.out.println("Testando exemplo de IfElse com a = " + valor1 + ":");
        cond.exemploIfElse(valor1);

        System.out.println("-----------------------------");

        System.out.println("Testando exemplo de IfElse com a = " + valor2 + ":");
        cond.exemploIfElse(valor2);

        System.out.println("-----------------------------");

        System.out.println("Testando o outro exemplo de IfElse com a = " + valor3 + ":");
        cond.outroExemploIfElse(valor3);
